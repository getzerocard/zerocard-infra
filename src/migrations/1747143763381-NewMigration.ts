...
export class NewMigration1747143763381 implements MigrationInterface {
    name = 'NewMigration1747143763381'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."funds_lock_status_enum" RENAME TO "funds_lock_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."funds_lock_status_enum" AS ENUM('LOCKED', 'UNLOCKED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."funds_lock_status_enum_old" AS ENUM('LOCKED', 'FREE')`);
        await queryRunner.query(`ALTER TABLE "funds_lock" ALTER COLUMN "status" DROP DEFAULT`);
